...
var Dropdown = function (props) {
    return (React.createElement("select", { name: "", id: "", className: "select-box" },
        React.createElement("option", { className: "opt", value: "" }),
...
var Input = function (props) {
    ...
    return (React.createElement("div", { style: {
        ...
        condition == "error" ? (React.createElement("div", null,
            React.createElement(default_1$4, { style: { fontSize: "12px", color: "red", paddingLeft: "8px" } }),
        ...
        condition == "success" ? (React.createElement("div", null,
            React.createElement(default_1$5, { style: { fontSize: "12px", color: "#5ca700", paddingLeft: "8px" } }),
        ...
        props.disabled == true ? (React.createElement("div", null,
            React.createElement(default_1$3, { style: { fontSize: "12px", color: "#e0e0e0", paddingLeft: "8px" } }),
...
var Select = function (props) {
    var _a = React.useState(false), selectIsOpen = _a[0], SetSelectIsOpen = _a[1];
    var _b = React.useState(""), inputValue = _b[0], setInputValue = _b[1];
    var _c = React.useState(props.value); _c[0]; var setSelectedOption = _c[1];
    // console.log(props.value);
    ...
    return (React.createElement("div", { className: "select-main-div" },
        React.createElement("label", { htmlFor: "", className: "storybook-select-label" },
            props.required && (React.createElement("span", { className: classNames("storybook-label-span") }, "*")),
            props.label,
            props.optional && (React.createElement("span", { className: classNames("storybook-label-span") }, "(Optional)"))),
        React.createElement("div", __assign({ 
            ...
            React.createElement("span", { style: { width: "100%", padding: "8px" } }, inputValue ? inputValue : props.placeholder),
            selectIsOpen ? React.createElement(default_1, null) : React.createElement(default_1$2, null)),
        selectIsOpen == true && (React.createElement("div", { className: "select-option-group" }, props.options.map(function (option) {
            return (React.createElement("li", { key: option.value, className: "select-option", 
                ...
                React.createElement("span", { style: {
                    ...
                    React.createElement("span", { style: { paddingLeft: "8px" } }, option.label))));
        })))));
};
