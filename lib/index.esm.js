...
var Checkbox = function (props) {
    ...
    return (React__default.createElement("div", { className: "".concat(disabled(props)) },
        React__default.createElement("input", __assign({ type: "checkbox", name: "", id: "", className: ["input", "checked", disabled(props)].join(" ") }, props)),
        React__default.createElement("label", { htmlFor: "", className: ["checkboxlabel", disabled(props)].join(" ") }, props.label)));
};

var css_248z$7 = ".select-box {\r\n  height: 35px;\r\n  width: 175px;\r\n  border-radius: 8px;\r\n  border: 0.5px solid #e0e0e0;\r\n}\r\n.dropdowndiv {\r\n  display: flex;\r\n  flex-direction: column;\r\n}\r\n.dropdownlabel {\r\n  font-family: \"Poppins\", sans-serif;\r\n  font-weight: 600;\r\n  font-size: 12px;\r\n  color: #8f8e8e;\r\n  padding: 5px;\r\n}\r\nselect option {\r\n  height: inherit;\r\n  color: #8f8e8e;\r\n}\r\n/* select option:hover{\r\n  background-color: #434DB8;\r\n  color: #fff;\r\n} */\r\nselect:focus {\r\n  outline: none;\r\n  outline: 1px solid #434db8;\r\n}\r\n\r\n.opt {\r\n  /* background-color: #434db8;\r\n  color: #fff; */\r\n  height: inherit;\r\n  color: #8f8e8e;\r\n}\r\n";
styleInject(css_248z$7);

var Dropdown = function (props) {
    return (React__default.createElement("select", { name: "", id: "", className: "select-box" },
        React__default.createElement("option", { className: "opt", value: "" }),
        React__default.createElement("option", { value: "" }, "sdfgh"),
        React__default.createElement("option", { value: "" }, "sdfgh"),
        React__default.createElement("option", { value: "" }, "sdfgh")));
};
...
var _formatMuiErrorMessage2 = _interopRequireDefault$7(require$$1);
...
var _styledEngine = _interopRequireWildcard$1(require$$3);
...
var default_1$5 = CheckCircleOutlineRounded.default = void 0;
var _createSvgIcon$5 = _interopRequireDefault$5(requireCreateSvgIcon());
var _jsxRuntime$5 = require$$2$1;
default_1$5 = CheckCircleOutlineRounded.default = (0, _createSvgIcon$5.default)( /*#__PURE__*/(0, _jsxRuntime$5.jsx)("path", {
...
var css_248z$6 = "@import url(\"https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap\");\ninput {\n  width: 250px;\n  height: 35px;\n  font-size: 12px;\n  font-family: \"Poppins\";\n  font-weight: Regular;\n  padding: 0px 8px;\n  border-radius: 8px;\n  font-family: \"Poppins\", sans-serif;\n}\ninput:focus {\n  outline: none;\n}\ninput::placeholder {\n  color: #c4c3c3;\n}\n\n.label {\n  font-family: \"Poppins\", sans-serif;\n  font-weight: 600;\n  font-size: 12px;\n  color: #8f8e8e;\n  padding: 5px;\n}\n.label span {\n  font-size: 12px;\n  padding-right: 2px;\n  color: #c50303;\n}\n\n.msg {\n  padding-left: 6px;\n  font-family: \"Poppins\", sans-serif;\n}\n\n.default {\n  border: 0.5px solid #e0e0e0;\n}\n.default:focus {\n  border: 0.5px solid #434db8;\n}\n\n.success {\n  border: 0.5px solid #5ca700;\n}\n\n.warning {\n  border: 0.5px solid #ffc600;\n}\n\n.input1 {\n  border: 0.5px solid #434db8;\n}\n\n.error {\n  border: 0.5px solid #c50303;\n  background-color: #e2bcbc;\n}\n.error {\n  border-bottom: 1px solid red;\n}\n\n.disabled:disabled {\n  border: 0.5px solid #e0e0e0;\n  color: #e0e0e0;\n  cursor: not-allowed;\n}\n\n.disabled {\n  color: #e0e0e0;\n  cursor: not-allowed;\n}\n\n.sup {\n  color: #c50303;\n}\n\n.default:disabled,\n.error:disabled,\n.success:disabled,\n.input1:disabled,\n.warning:disabled {\n  border: 0.5px solid #e0e0e0;\n  color: #e0e0e0;\n  cursor: not-allowed;\n}\n\n.sm {\n  width: 100px;\n}\n\n.md {\n  width: 175px;\n}\n\n.lg {\n  width: 250px;\n}";
styleInject(css_248z$6);

var DangerousOutlined = {};

var _interopRequireDefault$4 = interopRequireDefaultExports;
Object.defineProperty(DangerousOutlined, "__esModule", {
  value: true
});
var default_1$4 = DangerousOutlined.default = void 0;
var _createSvgIcon$4 = _interopRequireDefault$4(requireCreateSvgIcon());
var _jsxRuntime$4 = require$$2$1;
default_1$4 = DangerousOutlined.default = (0, _createSvgIcon$4.default)( /*#__PURE__*/(0, _jsxRuntime$4.jsx)("path", {
...
var default_1$3 = InfoOutlined.default = void 0;
var _createSvgIcon$3 = _interopRequireDefault$3(requireCreateSvgIcon());
var _jsxRuntime$3 = require$$2$1;
default_1$3 = InfoOutlined.default = (0, _createSvgIcon$3.default)( /*#__PURE__*/(0, _jsxRuntime$3.jsx)("path", {
...
var Input = function (props) {
    ...
    return (React__default.createElement("div", { style: {
        ...
        React__default.createElement("label", { htmlFor: "", className: "label" },
            props.required ? React__default.createElement("span", null, "*") : React__default.createElement(React__default.Fragment, null),
            props.label,
            props.optional ? React__default.createElement("span", null, "(Optional)") : React__default.createElement(React__default.Fragment, null)),
        React__default.createElement("input", __assign({}, props, { type: props.type, className: [props.variant, props.size, condition].join(" "), placeholder: props.placeholder, name: props.name })),
        condition == "error" ? (React__default.createElement("div", null,
            React__default.createElement(default_1$4, { style: { fontSize: "12px", color: "red", paddingLeft: "8px" } }),
            React__default.createElement("span", { className: "msg", style: { color: "red", fontSize: "12px", paddingLeft: "8px" } }, props.Text))) : (React__default.createElement(React__default.Fragment, null)),
        condition == "success" ? (React__default.createElement("div", null,
            React__default.createElement(default_1$5, { style: { fontSize: "12px", color: "#5ca700", paddingLeft: "8px" } }),
            React__default.createElement("span", { className: "msg", style: { color: "#5ca700", fontSize: "12px", padding: "0px 5px" } }, props.Text))) : (React__default.createElement(React__default.Fragment, null)),
        condition == "warning" ? (React__default.createElement("span", { className: "msg", style: { color: "#ffc600", fontSize: "12px", paddingLeft: "8px" } }, props.Text)) : (React__default.createElement(React__default.Fragment, null)),
        props.disabled == true ? (React__default.createElement("div", null,
            React__default.createElement(default_1$3, { style: { fontSize: "12px", color: "#e0e0e0", paddingLeft: "8px" } }),
            React__default.createElement("span", { className: ["msg", disabled(props)].join(" "), style: { color: "#e0e0e0", fontSize: "12px", paddingLeft: "8px" } }, props.Text))) : (React__default.createElement(React__default.Fragment, null))));
};

var css_248z$5 = ".radiolabel {\r\n    font-family: \"Poppins\", sans-serif;\r\n    font-size: 12px;\r\n    color: #0f0e0e;\r\n    padding: 2px;\r\n    background-color: transparent;\r\n    position: relative;\r\n    bottom: 2px;\r\n  }\r\n  .disabledRadio {\r\n    color: #e0e0e0;\r\n    /* background-color: red; */\r\n  }\r\n  .radioinput{\r\n      accent-color: #434db8;\r\n      height: 12px;\r\n      width: 12px;\r\n  }";
...
var Radio = function (props) {
    ...
    return (React__default.createElement("div", { className: "".concat(disabled(props)), style: { width: "auto", display: "inline" } },
        React__default.createElement("input", __assign({ type: "radio", name: "", id: "", className: ["input", disabled(props)].join(" ") }, props)),
        React__default.createElement("label", { htmlFor: "", className: ["radiolabel", disabled(props)].join(" ") }, props.label)));
};

var css_248z$4 = "/* @import \"../../color\"; */\r\n\r\n.button {\r\n  width: auto;\r\n  border-radius: 5px;\r\n  color: white;\r\n  padding: 6px 12px;\r\n  text-align: center;\r\n  text-decoration: none;\r\n  display: inline-block;\r\n  font-size: 10px;\r\n}\r\n.primary {\r\n  color: #434db8;\r\n  border: 1px solid #434db8;\r\n}\r\n.primary:hover {\r\n  background-color: #434db8;\r\n  color: white;\r\n}\r\n.primary:active {\r\n  background-color: #434db8;\r\n  color: rgb(255, 255, 255);\r\n}\r\n.primary:disabled {\r\n  background-color: #434db8;\r\n  color: rgb(255, 255, 255);\r\n  opacity: 0.5;\r\n}\r\n.secondary {\r\n  color: #808080;\r\n  border: 1px solid #808080;\r\n}\r\n.secondary:hover {\r\n  background-color: #808080;\r\n  color: white;\r\n}\r\n.secondary:active {\r\n  background-color: #808080;\r\n  color: white;\r\n}\r\n.secondary:disabled {\r\n  background-color: #808080;\r\n  color: white;\r\n  opacity: 0.5;\r\n}\r\n.danger {\r\n  color: #c50303;\r\n  border: 1px solid #c50303;\r\n}\r\n.danger:hover {\r\n  background-color: #c50303;\r\n  color: white;\r\n}\r\n.danger:active {\r\n  background-color: #c50303;\r\n  color: white;\r\n}\r\n.danger:disabled {\r\n  background-color: #c50303;\r\n  color: white;\r\n  opacity: 0.5;\r\n}\r\n.success {\r\n  color: #5ca700;\r\n  border: 1px solid #5ca700;\r\n}\r\n.success:hover {\r\n  background-color: #5ca700;\r\n  color: white;\r\n}\r\n.success:active {\r\n  background-color: #5ca700;\r\n  color: white;\r\n}\r\n.success:disabled {\r\n  background-color: #5ca700;\r\n  color: white;\r\n  opacity: 0.5;\r\n}\r\n.small {\r\n  font-size: 12px;\r\n  padding: 10px 16px;\r\n}\r\n.medium {\r\n  font-size: 14px;\r\n  padding: 11px 20px;\r\n}\r\n.large {\r\n  font-size: 16px;\r\n  padding: 12px 24px;\r\n}\r\n";
...
var Button = function (_a) {
    ...
    return (React__default.createElement("button", __assign({ type: "button", className: ['button', "".concat(size), mode].join(' '), style: { backgroundColor: backgroundColor } }, props), label));
};

var css_248z$3 = ".storybook-header {\n  font-family: 'Nunito Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;\n  border-bottom: 1px solid rgba(0, 0, 0, 0.1);\n  padding: 15px 20px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n\n.storybook-header svg {\n  display: inline-block;\n  vertical-align: top;\n}\n\n.storybook-header h1 {\n  font-weight: 700;\n  font-size: 20px;\n  line-height: 1;\n  margin: 6px 0 6px 10px;\n  display: inline-block;\n  vertical-align: top;\n}\n\n.storybook-header button + button {\n  margin-left: 10px;\n}\n\n.storybook-header .welcome {\n  color: #333;\n  font-size: 14px;\n  margin-right: 10px;\n}\n";
...
var Header = function (_a) {
    ...
    return (React__default.createElement("header", null,
        React__default.createElement("div", { className: "storybook-header" },
            React__default.createElement("div", null,
                React__default.createElement("svg", { width: "32", height: "32", viewBox: "0 0 32 32", xmlns: "http://www.w3.org/2000/svg" },
                    React__default.createElement("g", { fill: "none", fillRule: "evenodd" },
                        React__default.createElement("path", { d: "M10 0h12a10 10 0 0110 10v12a10 10 0 01-10 10H10A10 10 0 010 22V10A10 10 0 0110 0z", fill: "#FFF" }),
                        React__default.createElement("path", { d: "M5.3 10.6l10.4 6v11.1l-10.4-6v-11zm11.4-6.2l9.7 5.5-9.7 5.6V4.4z", fill: "#555AB9" }),
                        React__default.createElement("path", { d: "M27.2 10.6v11.2l-10.5 6V16.5l10.5-6zM15.7 4.4v11L6 10l9.7-5.5z", fill: "#91BAF8" }))),
                React__default.createElement("h1", null, "Acme")),
            React__default.createElement("div", null, user ? (React__default.createElement(React__default.Fragment, null,
                React__default.createElement("span", { className: "welcome" },
                    "Welcome, ",
                    React__default.createElement("b", null, user.name),
                    "!"),
                React__default.createElement(Button, { size: "small", onClick: onLogout, label: "Log out" }))) : (React__default.createElement(React__default.Fragment, null,
                React__default.createElement(Button, { size: "small", onClick: onLogin, label: "Log in" }),
                React__default.createElement(Button, { primary: true, size: "small", onClick: onCreateAccount, label: "Sign up" })))))));
};

var css_248z$2 = ".storybook-page {\n  font-family: 'Nunito Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif;\n  font-size: 14px;\n  line-height: 24px;\n  padding: 48px 20px;\n  margin: 0 auto;\n  max-width: 600px;\n  color: #333;\n}\n\n.storybook-page h2 {\n  font-weight: 700;\n  font-size: 32px;\n  line-height: 1;\n  margin: 0 0 4px;\n  display: inline-block;\n  vertical-align: top;\n}\n\n.storybook-page p {\n  margin: 1em 0;\n}\n\n.storybook-page a {\n  text-decoration: none;\n  color: #1ea7fd;\n}\n\n.storybook-page ul {\n  padding-left: 30px;\n  margin: 1em 0;\n}\n\n.storybook-page li {\n  margin-bottom: 8px;\n}\n\n.storybook-page .tip {\n  display: inline-block;\n  border-radius: 1em;\n  font-size: 11px;\n  line-height: 12px;\n  font-weight: 700;\n  background: #e7fdd8;\n  color: #66bf3c;\n  padding: 4px 12px;\n  margin-right: 10px;\n  vertical-align: top;\n}\n\n.storybook-page .tip-wrapper {\n  font-size: 13px;\n  line-height: 20px;\n  margin-top: 40px;\n  margin-bottom: 40px;\n}\n\n.storybook-page .tip-wrapper svg {\n  display: inline-block;\n  height: 12px;\n  width: 12px;\n  margin-right: 4px;\n  vertical-align: top;\n  margin-top: 3px;\n}\n\n.storybook-page .tip-wrapper svg path {\n  fill: #1ea7fd;\n}\n";
styleInject(css_248z$2);

var Page = function () {
    var _a = React__default.useState(), user = _a[0], setUser = _a[1];
    return (React__default.createElement("article", null,
        React__default.createElement(Header, { user: user, onLogin: function () { return setUser({ name: 'Jane Doe' }); }, onLogout: function () { return setUser(undefined); }, onCreateAccount: function () { return setUser({ name: 'Jane Doe' }); } }),
        React__default.createElement("section", { className: "storybook-page" },
            React__default.createElement("h2", null, "Pages in Storybook"),
            React__default.createElement("p", null,
                "We recommend building UIs with a",
                ' ',
                React__default.createElement("a", { href: "https://componentdriven.org", target: "_blank", rel: "noopener noreferrer" },
                    React__default.createElement("strong", null, "component-driven")),
                ' ',
                "process starting with atomic components and ending with pages."),
            React__default.createElement("p", null, "Render pages with mock data. This makes it easy to build and review page states without needing to navigate to them in your app. Here are some handy patterns for managing page data in Storybook:"),
            React__default.createElement("ul", null,
                React__default.createElement("li", null, "Use a higher-level connected component. Storybook helps you compose such data from the \"args\" of child component stories"),
                React__default.createElement("li", null, "Assemble data in the page component from your services. You can mock these services out using Storybook.")),
            React__default.createElement("p", null,
                "Get a guided tutorial on component-driven development at",
                ' ',
                React__default.createElement("a", { href: "https://storybook.js.org/tutorials/", target: "_blank", rel: "noopener noreferrer" }, "Storybook tutorials"),
                ". Read more in the",
                ' ',
                React__default.createElement("a", { href: "https://storybook.js.org/docs", target: "_blank", rel: "noopener noreferrer" }, "docs"),
                "."),
            React__default.createElement("div", { className: "tip-wrapper" },
                React__default.createElement("span", { className: "tip" }, "Tip"),
                " Adjust the width of the canvas with the",
                ' ',
                React__default.createElement("svg", { width: "10", height: "10", viewBox: "0 0 12 12", xmlns: "http://www.w3.org/2000/svg" },
                    React__default.createElement("g", { fill: "none", fillRule: "evenodd" },
                        React__default.createElement("path", { d: "M1.5 5.2h4.8c.3 0 .5.2.5.4v5.1c-.1.2-.3.3-.4.3H1.4a.5.5 0 01-.5-.4V5.7c0-.3.2-.5.5-.5zm0-2.1h6.9c.3 0 .5.2.5.4v7a.5.5 0 01-1 0V4H1.5a.5.5 0 010-1zm0-2.1h9c.3 0 .5.2.5.4v9.1a.5.5 0 01-1 0V2H1.5a.5.5 0 010-1zm4.3 5.2H2V10h3.8V6.2z", id: "a", fill: "#999" }))),
                "Viewports addon in the toolbar"))));
};

var css_248z$1 = ".loader {\n  height: 20px;\n  width: 20px;\n  border-radius: 50%;\n}\n\n.loader-Default {\n  border: 3px solid transparent;\n  border-top: 3px solid #434db8;\n  border-bottom: 3px solid #434db8;\n  animation: loading 1.3s linear infinite;\n}\n@keyframes loading {\n  100% {\n    transform: rotate(360deg); /* Rotate 360 degrees */\n  }\n}\n\n.loader-Loader1 {\n  border: 3px solid transparent;\n  border-top: 3px solid #434db8;\n  border-right: 3px solid rgb(250, 71, 71);\n  border-left: 3px solid rgb(250, 185, 64);\n  border-bottom: 3px solid #434db8;\n  animation: loading 1.3s linear infinite;\n  display: inline-block;\n}\n@keyframes loading {\n  100% {\n    transform: rotate(360deg); /* Rotate 360 degrees */\n  }\n}\n\n.loader-Loader2 {\n  border-top: 4px solid #434db8;\n  border-bottom: 4px solid #434db8;\n  animation: loading 1.3s linear infinite;\n  display: inline-block;\n}\n@keyframes loading {\n  100% {\n    transform: rotate(360deg); /* Rotate 360 degrees */\n  }\n}\n\n.loader-Loader3 {\n  border: 3px solid #cecdcd;\n  border-top: 3px solid #434db8;\n  animation: loading 1.3s linear infinite;\n  display: inline-block;\n}\n@keyframes loading {\n  100% {\n    transform: rotate(360deg); /* Rotate 360 degrees */\n  }\n}\n\n.loader {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.inner-loader {\n  display: inline-block;\n  height: 17px;\n  width: 17px;\n  border: 3px solid transparent;\n  border-right: 3px solid #303aa2;\n  border-left: 3px solid #303aa2;\n  border-radius: 50%;\n  animation: loading 0.7s linear infinite reverse;\n  display: inline-block;\n}\n@keyframes loading {\n  100% {\n    transform: rotate(360deg); /* Rotate 360 degrees */\n  }\n}";
...
var Loader = function (props) {
    return (React__default.createElement("span", __assign({ className: classNames("loader", "loader-".concat(props.variant), "loader-size-".concat(props.loadersize)) }, props, { style: {
            height: "".concat(props.loadersize, "px"),
            width: "".concat(props.loadersize, "px"),
            borderWidth: "".concat(props.borderWidth, "px "),
        } }), props.variant === "Default" && (React__default.createElement("span", __assign({ className: classNames("inner-loader", "inner-loader-size-".concat(props.loadersize)) }, props, { style: {
...
var css_248z = "@import url(\"https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap\");\n.select-main-div {\n  height: 35px;\n  font-family: \"Poppins\";\n  font-size: 12px;\n  min-width: 175px;\n}\n\n.select-inner-div {\n  width: 100%;\n  height: 35px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-direction: row;\n  border-radius: 6px;\n  cursor: pointer;\n  border: 1px solid #E0E0E0;\n}\n.select-inner-div span {\n  transition: 1s;\n}\n.select-inner-div:focus {\n  border: 1px solid rgb(128, 128, 207);\n}\n.select-inner-div:disabled {\n  border: 1px solid grey;\n}\n.select-inner-div:active {\n  border: 1px solid rgb(128, 128, 207);\n}\n\n.select-option-group {\n  width: 100%;\n  max-height: 140px;\n  padding-top: 8px;\n  padding-bottom: 16px;\n  display: flex;\n  justify-content: start;\n  align-items: center;\n  flex-direction: column;\n  margin-top: 5px;\n  text-wrap: wrap;\n  border-radius: 5px;\n  box-shadow: 0px 0px 3px 3px #e7e6e6;\n  overflow-y: auto;\n}\n\n.select-option {\n  list-style: none;\n  background-color: #ffffff;\n  width: 100%;\n  border: none;\n  height: 35px;\n  display: flex;\n  justify-content: start;\n  align-items: center;\n  transition: 0.15s;\n  color: #8f8e8e;\n  position: relative;\n  cursor: pointer;\n}\n.select-option:hover {\n  background-color: #434db8;\n  color: #ffffff;\n}\n\n.storybook-select-label {\n  font-family: \"Poppins\", sans-serif;\n  font-weight: 600;\n  font-size: 12px;\n  color: #8f8e8e;\n  padding: 5px;\n}\n.storybook-select-label .storybook-label-span {\n  font-size: 12px;\n  padding-right: 2px;\n  color: red;\n}\n\n.select-disabled {\n  border: 1px solid rgb(128, 128, 128);\n  cursor: default;\n}\n.select-disabled:focus {\n  border: 1px solid rgb(128, 128, 128);\n}\n\n.select-box {\n  height: 35px;\n  width: 175px;\n  border-radius: 8px;\n  border: 0.5px solid #e0e0e0;\n}";
...
var default_1$2 = ArrowDropDown.default = void 0;
var _createSvgIcon$2 = _interopRequireDefault$2(requireCreateSvgIcon());
var _jsxRuntime$2 = require$$2$1;
default_1$2 = ArrowDropDown.default = (0, _createSvgIcon$2.default)( /*#__PURE__*/(0, _jsxRuntime$2.jsx)("path", {
  d: "m7 10 5 5 5-5z"
}), 'ArrowDropDown');
...
var default_1$1 = Google.default = void 0;
...
default_1$1 = Google.default = (0, _createSvgIcon$1.default)( /*#__PURE__*/(0, _jsxRuntime$1.jsx)("path", {
...
var default_1 = ArrowDropUp.default = void 0;
var _createSvgIcon = _interopRequireDefault(requireCreateSvgIcon());
var _jsxRuntime = require$$2$1;
default_1 = ArrowDropUp.default = (0, _createSvgIcon.default)( /*#__PURE__*/(0, _jsxRuntime.jsx)("path", {
  d: "m7 14 5-5 5 5z"
}), 'ArrowDropUp');
...
var Select = function (props) {
    ...
    // console.log(inputValue);
    // console.log(props.value);
    var disabled = props.disabled && "select-disabled";
    ...
    return (React__default.createElement("div", { className: "select-main-div" },
        React__default.createElement("label", { htmlFor: "", className: "storybook-select-label" },
            props.required && (React__default.createElement("span", { className: classNames("storybook-label-span") }, "*")),
            props.label,
            props.optional && (React__default.createElement("span", { className: classNames("storybook-label-span") }, "(Optional)"))),
        React__default.createElement("div", __assign({ 
            // className="select-inner-div"
            className: classNames("select-inner-div", "".concat(disabled)), onClick: handleSelectOpen, 
            // onBlur={handleBlur}
            onFocus: action("onFocus"), tabIndex: 0 }, props),
            React__default.createElement("span", { style: { width: "100%", padding: "8px" } }, inputValue ? inputValue : props.placeholder),
            selectIsOpen ? React__default.createElement(default_1, null) : React__default.createElement(default_1$2, null)),
        selectIsOpen == true && (React__default.createElement("div", { className: "select-option-group" }, props.options.map(function (option) {
            return (React__default.createElement("li", { key: option.value, className: "select-option", 
                ...
                React__default.createElement("span", { style: {
                    ...
                    React__default.createElement("span", { style: { paddingLeft: "8px" } }, option.label))));
        })))));
};

export { Button, Checkbox, Dropdown, Header, Input, Loader, Page, Radio, Select };
